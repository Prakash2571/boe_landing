// Static course catalog rendered directly by the public Courses page.
// Education-only content. Edit here to add or change courses — no backend
// or database required for the marketing pages to display them.
...
export const courseCatalog: Course[] = [
  {
    ...
    description: 'A plain-language introduction to how money moves in everyday life — what comes in, what goes out, and how to keep a clear picture of both.',
  ...
  },
  {
    ...
    description: 'Practical budgeting methods you can actually stick to, with ready-to-use worksheets for monthly planning and expense tracking.',
  ...
  },
  {
    ...
    description: 'Learn how to save consistently and size an emergency fund that fits your real life, so unexpected costs do not derail you.',
  ...
  },
  {
    ...
    description: 'Understand different kinds of debt, build a clear repayment plan, and learn what actually affects your credit score.',
  ...
  },
  {
    ...
    description: 'Demystify common tax terms and learn which records to keep and how to stay organised through the year.',
  ...
  },
  {
    ...
    description: 'Build simple systems for managing money as a household, from shared budgets to talking about money together.',
  ...
  },
  {
    ...
    description: 'Strategies for managing unpredictable freelance income, smoothing cash flow, and setting money aside for taxes and lean months.',
  ...
  },
  {
    ...
    description: 'Understand the basics of business cash flow so you can read the numbers and plan ahead through busy and quiet periods.',
  ...
  },
  {
    ...
    description: 'Learn how to read financial and economic news critically, cut through the jargon, and focus on what is relevant to you.',
  ...
  },
  {
    ...
    description: 'Build simple, repeatable habits and checklists that help you make calmer, more confident spending decisions.',
  ...
  },
  {
    ...
    description: 'A beginner-friendly overview of common insurance types and how protection fits into an overall money plan — purely educational.',
  ...
  },
  {
    ...
    description: 'Turn big, far-off money goals into clear milestones with steady steps you can follow over months and years.',
  ...
  },
  {
    ...
    description: 'Practical safety habits for UPI, cards, and online payments, plus how to recognise and avoid common money scams.',
  ...
  },
  {
    ...
    description: 'Learn to read bank, card, and loan statements line by line so you understand charges and can catch errors quickly.',
  ...
  },
  {
    ...
    description: 'Set up dedicated saving buckets for specific goals and use trackers to keep each one moving forward.',
